...
function ExperienceCard({ heading, content, image }) {
  return (
    <div className="min-w-72 sm:min-w-64 my-4 sm:my-0 min-h-72 rounded-xl border-none overflow-hidden shadow-[4px_8px_9px_2px_#00000024]">
      ...
      <div className="experience_description h-full  bg-slate-800 text-gray-50  px-3 py-3">
        ...
        <p className="text-sm mt-2 leading-6 pb-4">{content}</p>
      </div>
    </div>
  );
}
